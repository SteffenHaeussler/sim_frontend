class App {
  ...
  setupEventListeners() {
    ...
    this.askAgentButton.addEventListener("click", () =>
      this.handleServiceClickWithNewSession("ask-agent"),
    );
    this.lookupServiceButton.addEventListener("click", () =>
      this.handleServiceClickWithNewSession("lookup-service"),
    );

    this.askSqlAgentButton.addEventListener("click", () =>
      this.handleServiceClickWithNewSession("ask-sql-agent"),
    );
    this.scenarioButton.addEventListener("click", () =>
      this.handleServiceClickWithNewSession("scenario"),
    );

    this.searchButton.addEventListener("click", () =>
      this.handleServiceClick("search"),
    );
    this.libraryButton.addEventListener("click", () =>
      this.handleServiceClick("library"),
    );

    // User greeting click for new session
    if (this.userGreeting) {
      this.userGreeting.addEventListener("click", () =>
        this.handleProtectedAction("new-session"),
      );
    }
    ...
    document
      .querySelector("#theme-toggle-btn .icon-label")
      .addEventListener("click", () => this.toggleTheme());
    document
      .querySelector("#ask-agent-btn .icon-label")
      .addEventListener("click", () =>
        this.handleServiceClickWithNewSession("ask-agent"),
      );
    document
      .querySelector("#lookup-service-btn .icon-label")
      .addEventListener("click", () =>
        this.handleServiceClickWithNewSession("lookup-service"),
      );

    document
      .querySelector("#ask-sql-agent-btn .icon-label")
      .addEventListener("click", () =>
        this.handleServiceClickWithNewSession("ask-sql-agent"),
      );
    document
      .querySelector("#scenario-btn .icon-label")
      .addEventListener("click", () =>
        this.handleServiceClickWithNewSession("scenario"),
      );

    document
      .querySelector("#search-btn .icon-label")
      .addEventListener("click", () => this.handleServiceClick("search"));
    document
      .querySelector("#library-btn .icon-label")
      .addEventListener("click", () => this.handleServiceClick("library"));
  }
  ...
  updateTemplates(service) {
    ...
    if (service === "lookup-service") {
      ...
      const templateTexts =
        templateContainer.querySelectorAll(".template-text");
      ...
      sqlTemplates.forEach((templateText) => {
        ...
        templateDiv.addEventListener("click", () =>
          this.handleTemplateClick(templateDiv),
        );
