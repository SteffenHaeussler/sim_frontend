...
class ProfileManager {
  ...
  initializeElements() {
    ...
    this.updateProfileSubmitBtn = document.getElementById(
      "update-profile-submit",
    );
    this.deleteAccountSubmitBtn = document.getElementById(
      "delete-account-submit",
    );
    this.profileErrorDiv = document.getElementById("profile-error");

    // Password toggle
    this.toggleDeletePasswordBtn = document.getElementById(
