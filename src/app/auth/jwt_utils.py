...
def create_access_token(
    ...
    if expires_delta:
        ...
        expire = datetime.utcnow() + timedelta(hours=config.api_mode.JWT_EXPIRATION_HOURS)
...
def create_refresh_token(
    ...
    if expires_delta:
        ...
        expire = datetime.utcnow() + timedelta(days=config.api_mode.JWT_REFRESH_EXPIRATION_DAYS)
