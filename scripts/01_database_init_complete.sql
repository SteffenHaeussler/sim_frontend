...
CREATE INDEX idx_response_metadata_usage_log_id ON api_response_metadata(usage_log_id);
CREATE INDEX idx_response_metadata_status_code ON api_response_metadata(response_status_code);
CREATE INDEX idx_response_metadata_created_at ON api_response_metadata(created_at);
CREATE INDEX idx_response_ratings_response_id ON user_response_ratings(response_metadata_id);
CREATE INDEX idx_response_ratings_user_id ON user_response_ratings(user_id);
CREATE INDEX idx_response_ratings_session_id ON user_response_ratings(session_id);
CREATE INDEX idx_response_ratings_type ON user_response_ratings(rating_type);
CREATE INDEX idx_response_ratings_rated_at ON user_response_ratings(rated_at);
