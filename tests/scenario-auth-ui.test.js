...
describe('Scenario Authentication UI', () => {
    ...
    it('should not allow WebSocket connection without token', () => {
        ...
        const mockScenarioAgent = {
            connectWebSocket: vi.fn().mockRejectedValue(new Error('Authentication required'))
        };

        // Simulate connection attempt
        expect(mockScenarioAgent.connectWebSocket()).rejects.toThrow('Authentication required');
    });
});