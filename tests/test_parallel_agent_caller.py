...
class TestParallelAgentCaller:
    ...
    async def test_call_multiple_agents_success(self):
        ...
        with patch.object(caller, '_call_sql_agent', new_callable=AsyncMock) as mock_sql:
            with patch.object(caller, '_call_tool_agent', new_callable=AsyncMock) as mock_tool:
