...
class TestScenarioAuthentication:
    ...
    def test_websocket_with_valid_token(self):
        ...
        user_id = uuid.uuid4()
        token = create_access_token(user_id=user_id, email="test@example.com", organisation_id=None)
        ...
        with patch("src.app.core.scenario_router.ScenarioService") as mock_service:
            ...
            with client.websocket_connect(
                ...
                # Send a test message
                websocket.send_json({"type": "query", "query": "Test query", "message_id": "test-msg-1"})
